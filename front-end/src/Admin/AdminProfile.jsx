  ...
  return (
    ...
    <div className="admin-profile" style={{ display: "flex", gap: "15px", marginLeft: "8%" }}>
      ...
      <div className="profile-details" style={{  width: "900px", height: "550px", padding: "20px", boxShadow: "0 4px 8px rgba(0,0,0,0.4)" }}>
        <Typography variant='h4'>Edit Details</Typography><br></br>
...
{isEditing ? (
  <button style={{ padding: '8px 16px', fontSize: '16px', backgroundColor: 'blue', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }} onClick={handleSaveClick}>Save</button>
) : (
  <button style={{ padding: '8px 16px', fontSize: '16px', backgroundColor: 'green', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }} onClick={handleEditClick}>Edit</button>
)}
